...
- `--host` overrides `server.host` for the optional observability service bind address (default:
  `127.0.0.1`)
...
- `server.host` controls the optional observability service bind address. CLI `--host` overrides it
  when provided.
